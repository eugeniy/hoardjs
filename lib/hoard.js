...
Hoard.views.ReservationList = Backbone.View.extend({
    ...
    events: { 'submit .reservations form': 'reserve' },

    initialize: function() {
        this.template = _.template($('#reservation-list-template').html());
...
Hoard.views.ResourceList = Backbone.View.extend({
    tagName: 'table',
    className: 'resources zebra-striped',
...
Hoard.views.Application = Backbone.View.extend({
    ...
    render: function() {
        ...
        this.$('.row').append(resource_form.render().el);
        return this;
    }
});
